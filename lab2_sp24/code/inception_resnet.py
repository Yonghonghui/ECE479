...
def InceptionResNetV1Norm(input_shape=(160, 160, 3),
    ...
    # Your code goes here
    for i in range(5):
        x = resnet_block(x, 0.17, i+1, 'Inception_block_a', activation = 'relu')
    ...
    # Your code goes here
    for i in range(10):
        x = resnet_block(x, 0.1, i+1, 'Inception_block_b', activation = 'relu')
    ...
    # Your code goes here
    for i in range(5):
        x = resnet_block(x, 0.2, i+1, 'Inception_block_c', activation='relu')
